...
<script type="text/javascript"
	src="./WELCOME TO ICSSE 2017_files/jquery-1.7.2.min.js.tải xuống"></script>
<script src="./WELCOME TO ICSSE 2017_files/Common.js.tải xuống"
	type="text/javascript"></script>
<script src="./WELCOME TO ICSSE 2017_files/PagingContent.js.tải xuống"
	type="text/javascript"></script>
...
<link href="./WELCOME TO ICSSE 2017_files/lightbox.css" rel="stylesheet"
	type="text/css" />
<script src="./WELCOME TO ICSSE 2017_files/lightbox.min.js.tải xuống"
	type="text/javascript"></script>
	...
	<form name="form1" method="post"
		...
		<div>
			...
			<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT"
				...
				value="/wEPaA8FDzhkNDczNjIxMDgxMzBlYRgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnU7+ovJuSZjKghACvIq+Gs5It1RGg==" />
		</div>
...
//]]>
		...
		<script src="./WELCOME TO ICSSE 2017_files/WebResource(3).axd"
			type="text/javascript"></script>


		<script
			src="./WELCOME TO ICSSE 2017_files/Telerik.Web.UI.WebResource.axd"
			type="text/javascript"></script>
		<script type="text/javascript">
//<![CDATA[
...
//]]>
		...
		<script src="./WELCOME TO ICSSE 2017_files/jsdebug"
			type="text/javascript"></script>
		<script src="./WELCOME TO ICSSE 2017_files/jsdebug(1)"
			type="text/javascript"></script>
		<script src="./WELCOME TO ICSSE 2017_files/jsdebug(2)"
			type="text/javascript"></script>
		<script src="./WELCOME TO ICSSE 2017_files/jsdebug(3)"
			type="text/javascript"></script>
		<div>
...
//]]>
		...
		<link href="./WELCOME TO ICSSE 2017_files/mainPortlets.css"
			rel="stylesheet" />
		<script language="javascript" type="text/javascript">
    function SearchProcess(event) {
        if (event.keyCode == 13) {
										...
										<div id="ctl06_portlet_e28a24d5-befe-4213-a3d5-2e1ebcb2a71e"
											...
											<div>
												...
												<link href="./WELCOME TO ICSSE 2017_files/nivo-slider.css"
													rel="stylesheet" />
												<link href="./WELCOME TO ICSSE 2017_files/default.css"
													rel="stylesheet" />

												<script
													src="./WELCOME TO ICSSE 2017_files/jquery.nivo.slider.js.tải xuống"></script>
													...
													<div class="slider-wrapper theme-default">
														<div id="slider" class="nivoSlider" style="height: 350px;">
															...
															<img class="nivo-main-image"
																src="./WELCOME TO ICSSE 2017_files/HNQT2.jpg"
														...
														<tr>
															<td
																...
																<div style="text-align: center;">
																	<br> <strong><span
																			style="color: #0070c0;">WELCOME TO ICSSE 2017</span></strong>
																		...
																		&nbsp; <span style="font-size: 16px;">&nbsp;Systems
																			...
																			technology. A system can be considered as a
																			collection of entities and their interrelationships
																			gathered together to form a whole greater than the
																			sum of the entities. It also involves people,
																			organizations, cultures, activities and
																			interrelationships among them. While systems composed
																			of autonomous subsystems are not new, increased data
																			density, connectivity and ubiquitous computational
																			resources have increased their interdependence and
																			interaction complexity. This has in turn made the
																			already difficult job of planning, developing and
																			deploying complex systems even more difficult.<br>
																	</span></span><span style="font-size: 16px;"><span
																	style="font-size: 16px;"><span
																		style="text-align: justify; font-size: 16px;"><br>
																				&nbsp; &nbsp;Technology advancement not only
																				provides opportunities for improving system
																				capabilities but also introduces development risks
																				that must be weighed and managed. Thus, it is our
																				goal to bring together scholars from all areas to
																				have a forum to discuss, demonstrate and exchange
																				research ideas in the scope of system science and
																				engineering.</span><br style="text-align: justify;">
																	<br style="text-align: justify;"> <span
																			style="text-align: justify; font-size: 16px;">&nbsp;
																				&nbsp;The International Conference on Systems
																				Science and Engineering 2017 (ICSSE 2017) is an
																				international conference that will take place in Ho
																				Chi Minh City during July 21-23, 2017. This event
																				will provide a great opportunity for scientists,
																				engineers, and practitioners from all over the world
																				to present the latest system design concepts,
																				research results, developments and applications, as
																				well as to facilitate interactions between scholars
																				and practitioners. ICSSE 2017 will feature plenary
																				speeches in emerging technology topics given by
																				world renowned scholars. The proceedings of ICSSE
																				2017 will be published by the IEEE with EI indexing.
																				In addition, selected high-quality papers will be
																				published by special issues of SCI-indexed journals.</span>&nbsp;</span><br></span>
																<br> <strong>ICSSE <strong
												...
												<div class="thongbao_phong">
													<div class="topictb_phong_blue">
														...
														<a class="wobble-horizontal"
															...
															<img
															src="./WELCOME TO ICSSE 2017_files/arrow_all_phong.png" />
														</a>
													</div>
										...
										<div id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666"
											...
											<div>
												...
												<div class="truycap_ute">
													<p>
														Visit month: <span
															id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">3,548</span>
													</p>
													<p class="line_footer"></p>
													<p>
														Visit total:<span
															id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">7,026</span>
													</p>
												</div>
	...
	<div id="lightbox" class="lightbox" style="display: none;">
		<div class="lb-outerContainer">
			<div class="lb-container">
				<img class="lb-image" src="http://icsse2017.hcmute.edu.vn/"><div
						class="lb-nav">
